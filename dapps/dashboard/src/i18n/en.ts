...
export default {
  "_bmvi": {
    ...
    "overview": {
      "usecase": {
        "desc": "Border information of the use case and data used",
        "title": "What have we done?"
      },
      "vehicles": {
        "desc": "Autonomous vehicles, their status, route, financing and maintenance",
