...
export function startDApp(container, dbcpName, dappEnsOrContract, dappBaseUrl) {
    return __awaiter(this, void 0, void 0, function () {
        var domainName, vueCoreDbcp, bmviBaseUrl;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    domainName = dappBrowser.getDomainName();
                    return [4 /*yield*/, dappBrowser.System.import("bmvi." + domainName + "!ens")];
                case 1:
                    vueCoreDbcp = _a.sent();
                    bmviBaseUrl = dappBrowser.dapp.getDAppBaseUrl(vueCoreDbcp, vueCoreDbcp.name + "." + domainName);
                    return [4 /*yield*/, initializeVue({
