...
var domainName = dappBrowser.getDomainName();
var i18nPref = '_evan._routes';
var DashboardRootComponent = /** @class */ (function (_super) {
    __extends(DashboardRootComponent, _super);
